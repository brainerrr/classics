...
rolls = Car.create!(brand: "Rolls Royce", model: "V", year: "1962", price_day: 530 , category: "British", description: "The Rolls-Royce Phantom V is a large four-door limousine produced by Rolls-Royce Limited from 1959 to 1968. Based on the Silver Cloud II, it shared a V8 engine and General Motors Hydra-Matic automatic gearbox with that model. Rolls-Royce assembled the cars' chassis and drivetrains with bodies made to standard designs by coachbuilders Park Ward, and James Young, former vendors absorbed by Rolls-Royce.", user: User.first)
